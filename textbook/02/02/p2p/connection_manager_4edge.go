...
func NewConnectionManager4Edge(host string, port uint16, bootStrap *Node) ConnectionManagerI {
...
func (c *ConnectionManager4Edge) JoinNetwork(bootstrapNode *Node) error {
	// for core node
	c.bootstrapNode = bootstrapNode
	return c.connectToP2PNW(bootstrapNode)
}

func (c *ConnectionManager4Edge) connectToP2PNW(bootstrapNode *Node) error {
